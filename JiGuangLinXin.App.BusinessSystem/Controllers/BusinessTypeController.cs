...
namespace JiGuangLinXin.App.BusinessSystem.Controllers
{
    ...
    {
        private LifestyleTypeCore typeCore = new LifestyleTypeCore();
        /// <summary>
        /// 商品分类列表
        /// </summary> 
        /// <returns></returns>
        ...
        public ResultMessageViewModel EditList([FromBody] JObject value)
        {
            ...
            if (itemList.Any())
            {
                ...
                {
                    Core_LifestyleType item = new Core_LifestyleType()
                    {
        ...
        public ResultMessageViewModel Add([FromBody] JObject value)
        {
            ...
            Core_LifestyleType tp = new Core_LifestyleType()
            {
                T_Rank = obj.rank,
                T_Recom = obj.recom,
                T_State = obj.state,
        ...
        public ResultMessageViewModel Edit([FromBody] JObject value)
        {
            ...
            dynamic obj = value;
            int tid = obj.tid;
            Core_LifestyleType tp = typeCore.LoadEntity(o => o.T_Id == tid);
            if (tp != null)
            {
                tp.T_Rank = obj.rank;
