...
namespace JiGuangLinXin.App.BusinessSystem.Controllers
{
    ...
    public class CheckController : BaseAdminController
    {
        ...
        /// 如果不更改分类，category -1
        /// 
        /// 如果不重分社区，remar="" buidlings=null
        /// 
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public ResultMessageViewModel BusinessEdit([FromBody] JObject value)
        {
            ResultMessageViewModel rs = new ResultMessageViewModel();
            dynamic obj = value;
            Guid busId = obj.busId; 
            ...
            if (busCore.EditBusBuilding(busId, category, buildings, remark))
            { 
                #region 消息推送
