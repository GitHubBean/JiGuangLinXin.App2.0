...
namespace JiGuangLinXin.App.Provide.ImgHelper
{
    ...
    public class WaterImageManage
    {
                                          ...
                                          string PicturePath)
        {
            ...
            // 目标图片名称及全路径   
            //   
            string targetFileName = Guid.NewGuid().ToString("N") + ".jpg";
            string targetImage = PicturePath + "v/" + targetFileName;
            ...
            crFont = new Font("微软雅黑", 29, FontStyle.Regular);
            ...
            grPhoto.FillRectangle(new SolidBrush(Color.FromArgb(255, 5, 196, 162)), new RectangleF(new PointF(xPosOfWm, yPosOfWm), grPhoto.MeasureString(waterWords, crFont)));
