...
namespace JiGuangLinXin.App.Provide.ExceptionMsg
{
    /// <summary>
    ///     异常信息封装类
    /// </summary>
    public class ExceptionMessage
    {
        ...
        /// <param name="log"> 是否自动记录错误日志 </param>
        public ExceptionMessage(Exception e, string userMessage = null, bool isHideStackTrace = false,bool log = true)
        {
            ...
            if (log)
            {
                ...
                l.Write(string.Format("{0}\n自定义信息：{1}", ErrorDetails,userMessage), LogLevel.Error);
            }
        }
