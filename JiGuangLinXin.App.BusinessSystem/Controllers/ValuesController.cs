    ...
    { 
        ...
        public string Post()
        {
            ...
            if (file != null)
            {
                ...
                string initParams = HttpContext.Current.Request.Form["__initParams"];
                result.sourceUrl = string.Format("bcupload/csharp_source_{0}.{1}", fileName, sourceExtendName);
                file.SaveAs(StaticFilePath + result.sourceUrl);
            ...
            for (int i = 0; i < avatars_length; i++)
            {
                ...
                if (file != null)
                {
                    ...
                    string virtualPath = string.Format("bcupload/csharp_avatar{0}_{1}.jpg", avatar_number, fileName);
                    result.avatarUrls.Add(virtualPath);
                    file.SaveAs(StaticFilePath + (virtualPath));
                    /*
            ...
            result.userid = HttpContext.Current.Request.Form["userid"];
            result.username = HttpContext.Current.Request.Form["username"];
